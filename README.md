...
Open **[Resume Keyword Checker in the browser](https://devilking7x.github.io/resume-keyword-checker/)**. The default deployment uses GitHub Pages and does not require a custom domain.
